    ...
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-8 py-16">
        <div className="mb-10">
          ...
          <p className="text-zinc-400 text-xl">Saved on this browser.</p>
        </div>
        ...
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-6 mb-10">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <button
              onClick={handleAdd}
              className="rounded-xl bg-orange-500 px-6 py-3 font-semibold hover:bg-orange-400"
            >
              Add
            </button>
          </div>
                ...
                {editingId === c.id ? (
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-3 py-2 font-mono text-xs"
                    />
                    <div className="flex gap-2">
                      <button
                        onClick={() => setEditingId(null)}
                        className="flex-1 rounded-xl border border-zinc-700 py-2 text-sm"
                      >
                        Cancel
                      </button>
                      <button
                        onClick={() => saveEdit(c.id)}
                        className="flex-1 rounded-xl bg-orange-500 py-2 text-sm font-semibold"
                      >
                        Save
                      </button>
                    </div>
                  ...
                  <>
                    ...
                    <div className="flex gap-2">
                      <Link
                        href={`/send?to=${c.address}`}
                        className="flex-1 text-center rounded-xl bg-orange-500 py-2 text-sm font-semibold hover:bg-orange-400"
                      >
                        Send
                      </Link>
                      <button
                        onClick={() => startEdit(c.id, c.name, c.address)}
